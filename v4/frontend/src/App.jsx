            ...
            <div style={{ width: '100%', maxWidth: '440px', padding: '0 16px', position: 'relative', zIndex: 1 }}>
                <div className="auth-card fade-in">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0 12px' }}>
                        ...
                        <span style={{ color: '#64748b', fontSize: 12 }}>SSO coming soon</span>
                        <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.08)' }} />
                    </div>
                    <p style={{ fontSize: 11, color: '#475569', textAlign: 'center', marginBottom: 16, lineHeight: 1.5 }}>
                        Google &amp; GitHub OAuth launching in v1.1
                    </p>
