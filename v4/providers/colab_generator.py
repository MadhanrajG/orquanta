...
class ColabGenerator:
    ...
    def _build_fine_tune(self, goal: str, model_id: str) -> list[dict]:
        return [
            _md_cell(f"# 🤖 OrQuanta — Auto-Generated Fine-Tuning Notebook\n**Goal:** {goal}\n\n> Generated by [OrQuanta](https://orquanta.com) · Free T4 GPU · No cost"),
            ...
            _code_cell([
                ...
                "",
                "print('\\n🎉 Job complete! Orchestrated by OrQuanta — https://orquanta.com')",
            ]),
        ]
    ...
    def _build_image_gen(self, goal: str, model_id: str) -> list[dict]:
        return [
            _md_cell(f"# 🎨 OrQuanta — Image Generation\n**Goal:** {goal}\n\n> Free T4 GPU via Kaggle · Orchestrated by [OrQuanta](https://orquanta.com)"),
            _code_cell([
